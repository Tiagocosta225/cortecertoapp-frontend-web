...
(function (global, factory) {
  ...
  const AArrowDown = createLucideIcon("a-arrow-down", __iconNode$oU);
  ...
  const AArrowUp = createLucideIcon("a-arrow-up", __iconNode$oT);
  ...
  const Accessibility = createLucideIcon("accessibility", __iconNode$oR);
  ...
  const Activity = createLucideIcon("activity", __iconNode$oQ);
  ...
  const AirVent = createLucideIcon("air-vent", __iconNode$oP);
  ...
  const Airplay = createLucideIcon("airplay", __iconNode$oO);
  ...
  const AlarmClockMinus = createLucideIcon("alarm-clock-minus", __iconNode$oM);
  ...
  const AlarmClockOff = createLucideIcon("alarm-clock-off", __iconNode$oL);
  ...
  const AlarmClockPlus = createLucideIcon("alarm-clock-plus", __iconNode$oK);
  ...
  const AlarmSmoke = createLucideIcon("alarm-smoke", __iconNode$oI);
  ...
  const AlignCenterVertical = createLucideIcon("align-center-vertical", __iconNode$oF);
  ...
  const AlignCenter = createLucideIcon("align-center", __iconNode$oE);
  ...
  const AlignJustify = createLucideIcon("align-justify", __iconNode$ot);
  ...
  const Antenna = createLucideIcon("antenna", __iconNode$o9);
  ...
  const Aperture = createLucideIcon("aperture", __iconNode$o7);
  ...
  const AppWindowMac = createLucideIcon("app-window-mac", __iconNode$o6);
  ...
  const AppWindow = createLucideIcon("app-window", __iconNode$o5);
  ...
  const Apple = createLucideIcon("apple", __iconNode$o4);
  ...
  const ArchiveRestore = createLucideIcon("archive-restore", __iconNode$o3);
  ...
  const ArchiveX = createLucideIcon("archive-x", __iconNode$o2);
  ...
  const Archive = createLucideIcon("archive", __iconNode$o1);
  ...
  const ArrowBigDownDash = createLucideIcon("arrow-big-down-dash", __iconNode$n$);

  const __iconNode$n_ = [["path", { d: "M15 6v6h4l-7 7-7-7h4V6h6z", key: "1thax2" }]];
  const ArrowBigDown = createLucideIcon("arrow-big-down", __iconNode$n_);

  const __iconNode$nZ = [
    ["path", { d: "M19 15V9", key: "1hci5f" }],
    ["path", { d: "M15 15h-3v4l-7-7 7-7v4h3v6z", key: "16tjna" }]
  ];
  const ArrowBigLeftDash = createLucideIcon("arrow-big-left-dash", __iconNode$nZ);

  const __iconNode$nY = [["path", { d: "M18 15h-6v4l-7-7 7-7v4h6v6z", key: "lbrdak" }]];
  const ArrowBigLeft = createLucideIcon("arrow-big-left", __iconNode$nY);

  const __iconNode$nX = [
    ["path", { d: "M5 9v6", key: "158jrl" }],
    ["path", { d: "M9 9h3V5l7 7-7 7v-4H9V9z", key: "1sg2xn" }]
  ];
  const ArrowBigRightDash = createLucideIcon("arrow-big-right-dash", __iconNode$nX);

  const __iconNode$nW = [["path", { d: "M6 9h6V5l7 7-7 7v-4H6V9z", key: "7fvt9c" }]];
  const ArrowBigRight = createLucideIcon("arrow-big-right", __iconNode$nW);

  const __iconNode$nV = [
    ["path", { d: "M9 19h6", key: "456am0" }],
    ["path", { d: "M9 15v-3H5l7-7 7 7h-4v3H9z", key: "1r2uve" }]
  ];
  const ArrowBigUpDash = createLucideIcon("arrow-big-up-dash", __iconNode$nV);

  const __iconNode$nU = [["path", { d: "M9 18v-6H5l7-7 7 7h-4v6H9z", key: "1x06kx" }]];
  const ArrowBigUp = createLucideIcon("arrow-big-up", __iconNode$nU);
  ...
  const ArrowDown01 = createLucideIcon("arrow-down-0-1", __iconNode$nT);
  ...
  const ArrowDown10 = createLucideIcon("arrow-down-1-0", __iconNode$nS);
  ...
  const ArrowDownAZ = createLucideIcon("arrow-down-a-z", __iconNode$nR);
  ...
  const ArrowDownFromLine = createLucideIcon("arrow-down-from-line", __iconNode$nQ);

  const __iconNode$nP = [
    ["path", { d: "M17 7 7 17", key: "15tmo1" }],
    ["path", { d: "M17 17H7V7", key: "1org7z" }]
  ];
  const ArrowDownLeft = createLucideIcon("arrow-down-left", __iconNode$nP);
  ...
  const ArrowDownNarrowWide = createLucideIcon("arrow-down-narrow-wide", __iconNode$nO);

  const __iconNode$nN = [
    ["path", { d: "m7 7 10 10", key: "1fmybs" }],
    ["path", { d: "M17 7v10H7", key: "6fjiku" }]
  ];
  const ArrowDownRight = createLucideIcon("arrow-down-right", __iconNode$nN);
  ...
  const ArrowDownToDot = createLucideIcon("arrow-down-to-dot", __iconNode$nM);
  ...
  const ArrowDownToLine = createLucideIcon("arrow-down-to-line", __iconNode$nL);
  ...
  const ArrowDownUp = createLucideIcon("arrow-down-up", __iconNode$nK);
  ...
  const ArrowDownZA = createLucideIcon("arrow-down-z-a", __iconNode$nI);

  const __iconNode$nH = [
    ["path", { d: "M12 5v14", key: "s699le" }],
    ["path", { d: "m19 12-7 7-7-7", key: "1idqje" }]
  ];
  const ArrowDown = createLucideIcon("arrow-down", __iconNode$nH);
  ...
  const ArrowLeftFromLine = createLucideIcon("arrow-left-from-line", __iconNode$nG);
  ...
  const ArrowLeftRight = createLucideIcon("arrow-left-right", __iconNode$nF);
  ...
  const ArrowLeftToLine = createLucideIcon("arrow-left-to-line", __iconNode$nE);

  const __iconNode$nD = [
    ["path", { d: "m12 19-7-7 7-7", key: "1l729n" }],
    ["path", { d: "M19 12H5", key: "x3x0zl" }]
  ];
  const ArrowLeft = createLucideIcon("arrow-left", __iconNode$nD);
  ...
  const ArrowRightLeft = createLucideIcon("arrow-right-left", __iconNode$nB);
  ...
  const ArrowUp = createLucideIcon("arrow-up", __iconNode$nm);
  ...
  const BadgeCent = createLucideIcon("badge-cent", __iconNode$n9);
  ...
  const BadgeCheck = createLucideIcon("badge-check", __iconNode$n8);
  ...
  const BadgeDollarSign = createLucideIcon("badge-dollar-sign", __iconNode$n7);
  ...
  const BadgeHelp = createLucideIcon("badge-help", __iconNode$n5);
  ...
  const BadgeIndianRupee = createLucideIcon("badge-indian-rupee", __iconNode$n4);
  ...
  const BadgeInfo = createLucideIcon("badge-info", __iconNode$n3);
  ...
  const BadgeJapaneseYen = createLucideIcon("badge-japanese-yen", __iconNode$n2);
  ...
  const BadgeMinus = createLucideIcon("badge-minus", __iconNode$n1);
  ...
  const BadgePoundSterling = createLucideIcon("badge-pound-sterling", __iconNode$m$);
  ...
  const BadgeRussianRuble = createLucideIcon("badge-russian-ruble", __iconNode$mZ);
  ...
  const BadgeSwissFranc = createLucideIcon("badge-swiss-franc", __iconNode$mY);
  ...
  const Badge = createLucideIcon("badge", __iconNode$mX);
  ...
  const Ban = createLucideIcon("ban", __iconNode$mV);
  ...
  const BanknoteArrowDown = createLucideIcon("banknote-arrow-down", __iconNode$mR);
  ...
  const Baseline = createLucideIcon("baseline", __iconNode$mM);
  ...
  const Bath = createLucideIcon("bath", __iconNode$mL);
  ...
  const BatteryCharging = createLucideIcon("battery-charging", __iconNode$mK);
  ...
  const BatteryMedium = createLucideIcon("battery-medium", __iconNode$mH);
  ...
  const BatteryWarning = createLucideIcon("battery-warning", __iconNode$mF);

  const __iconNode$mE = [
    ["rect", { width: "16", height: "10", x: "2", y: "7", rx: "2", ry: "2", key: "1w10f2" }],
    ["line", { x1: "22", x2: "22", y1: "11", y2: "13", key: "4dh1rd" }]
  ];
  const Battery = createLucideIcon("battery", __iconNode$mE);
  ...
  const Beaker = createLucideIcon("beaker", __iconNode$mD);
  ...
  const BedDouble = createLucideIcon("bed-double", __iconNode$mA);
  ...
  const BedSingle = createLucideIcon("bed-single", __iconNode$mz);
  ...
  const Beef = createLucideIcon("beef", __iconNode$mx);
  ...
  const BeerOff = createLucideIcon("beer-off", __iconNode$mw);
  ...
  const Beer = createLucideIcon("beer", __iconNode$mv);
  ...
  const BellElectric = createLucideIcon("bell-electric", __iconNode$mt);
  ...
  const BellPlus = createLucideIcon("bell-plus", __iconNode$mq);
  ...
  const BellRing = createLucideIcon("bell-ring", __iconNode$mp);
  ...
  const Bell = createLucideIcon("bell", __iconNode$mo);
  ...
  const Bitcoin = createLucideIcon("bitcoin", __iconNode$md);
  ...
  const Blinds = createLucideIcon("blinds", __iconNode$mb);
  ...
  const BluetoothOff = createLucideIcon("bluetooth-off", __iconNode$ma);
  ...
  const BluetoothSearching = createLucideIcon("bluetooth-searching", __iconNode$m7);

  const __iconNode$m6 = [["path", { d: "m7 7 10 10-5 5V2l5 5L7 17", key: "1q5490" }]];
  const Bluetooth = createLucideIcon("bluetooth", __iconNode$m6);
  ...
  const Bold = createLucideIcon("bold", __iconNode$m5);
  ...
  const Bolt = createLucideIcon("bolt", __iconNode$m4);
  ...
  const Bomb = createLucideIcon("bomb", __iconNode$m3);
  ...
  const Bone = createLucideIcon("bone", __iconNode$m2);
  ...
  const BookDown = createLucideIcon("book-down", __iconNode$lY);
  ...
  const BookHeadphones = createLucideIcon("book-headphones", __iconNode$lX);
  ...
  const BookHeart = createLucideIcon("book-heart", __iconNode$lW);
  ...
  const BookImage = createLucideIcon("book-image", __iconNode$lV);
  ...
  const BookOpen = createLucideIcon("book-open", __iconNode$lO);
  ...
  const BookPlus = createLucideIcon("book-plus", __iconNode$lN);
  ...
  const BookText = createLucideIcon("book-text", __iconNode$lM);
  ...
  const BookType = createLucideIcon("book-type", __iconNode$lL);
  ...
  const BookUp2 = createLucideIcon("book-up-2", __iconNode$lK);
  ...
  const BookUp = createLucideIcon("book-up", __iconNode$lJ);
  ...
  const BookmarkCheck = createLucideIcon("bookmark-check", __iconNode$lF);
  ...
  const Bookmark = createLucideIcon("bookmark", __iconNode$lB);
  ...
  const BoomBox = createLucideIcon("boom-box", __iconNode$lA);
  ...
  const BotMessageSquare = createLucideIcon("bot-message-square", __iconNode$lz);
  ...
  const BotOff = createLucideIcon("bot-off", __iconNode$ly);
  ...
  const Bot = createLucideIcon("bot", __iconNode$lx);
  ...
  const BowArrow = createLucideIcon("bow-arrow", __iconNode$lw);
  ...
  const Box = createLucideIcon("box", __iconNode$lv);
  ...
  const Boxes = createLucideIcon("boxes", __iconNode$lu);
  ...
  const BrainCircuit = createLucideIcon("brain-circuit", __iconNode$lr);
  ...
  const BrainCog = createLucideIcon("brain-cog", __iconNode$lq);
  ...
  const Brain = createLucideIcon("brain", __iconNode$lp);
  ...
  const BrickWallFire = createLucideIcon("brick-wall-fire", __iconNode$lo);
  ...
  const Brush = createLucideIcon("brush", __iconNode$lf);
  ...
  const Building2 = createLucideIcon("building-2", __iconNode$lb);
  ...
  const BusFront = createLucideIcon("bus-front", __iconNode$l9);
  ...
  const Bus = createLucideIcon("bus", __iconNode$l8);
  ...
  const CableCar = createLucideIcon("cable-car", __iconNode$l7);
  ...
  const Cable = createLucideIcon("cable", __iconNode$l6);
  ...
  const CakeSlice = createLucideIcon("cake-slice", __iconNode$l5);
  ...
  const Cake = createLucideIcon("cake", __iconNode$l4);
  ...
  const Calculator = createLucideIcon("calculator", __iconNode$l3);
  ...
  const Calendar1 = createLucideIcon("calendar-1", __iconNode$l2);
  ...
  const CalendarArrowDown = createLucideIcon("calendar-arrow-down", __iconNode$l1);
  ...
  const CalendarArrowUp = createLucideIcon("calendar-arrow-up", __iconNode$l0);
  ...
  const CalendarCheck = createLucideIcon("calendar-check", __iconNode$k_);
  ...
  const CalendarCog = createLucideIcon("calendar-cog", __iconNode$kY);
  ...
  const CalendarFold = createLucideIcon("calendar-fold", __iconNode$kW);
  ...
  const CalendarHeart = createLucideIcon("calendar-heart", __iconNode$kV);
  ...
  const CalendarMinus2 = createLucideIcon("calendar-minus-2", __iconNode$kU);
  ...
  const CalendarMinus = createLucideIcon("calendar-minus", __iconNode$kT);
  ...
  const CalendarOff = createLucideIcon("calendar-off", __iconNode$kS);
  ...
  const CalendarPlus = createLucideIcon("calendar-plus", __iconNode$kQ);
  ...
  const CalendarRange = createLucideIcon("calendar-range", __iconNode$kP);
  ...
  const CalendarSearch = createLucideIcon("calendar-search", __iconNode$kO);
  ...
  const CalendarSync = createLucideIcon("calendar-sync", __iconNode$kN);
  ...
  const CalendarX2 = createLucideIcon("calendar-x-2", __iconNode$kM);
  ...
  const CalendarX = createLucideIcon("calendar-x", __iconNode$kL);
  ...
  const Calendar = createLucideIcon("calendar", __iconNode$kK);
  ...
  const CaseUpper = createLucideIcon("case-upper", __iconNode$ku);
  ...
  const Castle = createLucideIcon("castle", __iconNode$kr);
  ...
  const Cat = createLucideIcon("cat", __iconNode$kq);
  ...
  const Cctv = createLucideIcon("cctv", __iconNode$kp);
  ...
  const ChartArea = createLucideIcon("chart-area", __iconNode$ko);
  ...
  const ChartBarBig = createLucideIcon("chart-bar-big", __iconNode$kn);
  ...
  const ChartBarDecreasing = createLucideIcon("chart-bar-decreasing", __iconNode$km);
  ...
  const ChartBarIncreasing = createLucideIcon("chart-bar-increasing", __iconNode$kl);
  ...
  const ChartBar = createLucideIcon("chart-bar", __iconNode$kj);
  ...
  const ChartCandlestick = createLucideIcon("chart-candlestick", __iconNode$ki);
  ...
  const ChartColumnBig = createLucideIcon("chart-column-big", __iconNode$kh);
  ...
  const ChartColumnDecreasing = createLucideIcon("chart-column-decreasing", __iconNode$kg);
  ...
  const ChartColumnStacked = createLucideIcon("chart-column-stacked", __iconNode$ke);
  ...
  const ChartColumn = createLucideIcon("chart-column", __iconNode$kb);
  ...
  const CheckCheck = createLucideIcon("check-check", __iconNode$k1);
  ...
  const CheckLine = createLucideIcon("check-line", __iconNode$k0);
  ...
  const CircleCheck = createLucideIcon("circle-check", __iconNode$ju);
  ...
  const CircleDollarSign = createLucideIcon("circle-dollar-sign", __iconNode$jo);
  ...
  const CircleMinus = createLucideIcon("circle-minus", __iconNode$je);
  ...
  const CircleX = createLucideIcon("circle-x", __iconNode$j0);
  ...
  const CornerLeftUp = createLucideIcon("corner-left-up", __iconNode$hB);
  ...
  const CornerUpLeft = createLucideIcon("corner-up-left", __iconNode$hy);
  ...
  const Database = createLucideIcon("database", __iconNode$hh);
  ...
  const Droplet = createLucideIcon("droplet", __iconNode$gH);
  ...
  const Droplets = createLucideIcon("droplets", __iconNode$gG);
  ...
  const FileDown = createLucideIcon("file-down", __iconNode$fS);
  ...
  const FileHeart = createLucideIcon("file-heart", __iconNode$fR);
  ...
  const FileImage = createLucideIcon("file-image", __iconNode$fP);
  ...
  const FilePlus = createLucideIcon("file-plus", __iconNode$fB);
  ...
  const FileQuestion = createLucideIcon("file-question", __iconNode$fA);
  ...
  const FileSearch2 = createLucideIcon("file-search-2", __iconNode$fy);
  ...
  const FileSearch = createLucideIcon("file-search", __iconNode$fx);
  ...
  const FileSliders = createLucideIcon("file-sliders", __iconNode$fw);
  ...
  const Film = createLucideIcon("film", __iconNode$fd);
  ...
  const Fingerprint = createLucideIcon("fingerprint", __iconNode$fc);
  ...
  const FireExtinguisher = createLucideIcon("fire-extinguisher", __iconNode$fb);
  ...
  const Flag = createLucideIcon("flag", __iconNode$f3);
  ...
  const FlaskConicalOff = createLucideIcon("flask-conical-off", __iconNode$e$);
  ...
  const FlaskConical = createLucideIcon("flask-conical", __iconNode$e_);
  ...
  const FoldVertical = createLucideIcon("fold-vertical", __iconNode$eP);
  ...
  const FolderDot = createLucideIcon("folder-dot", __iconNode$eJ);
  ...
  const FolderDown = createLucideIcon("folder-down", __iconNode$eI);
  ...
  const FolderMinus = createLucideIcon("folder-minus", __iconNode$eB);
  ...
  const FolderLock = createLucideIcon("folder-lock", __iconNode$eA);
  ...
  const FolderSearch2 = createLucideIcon("folder-search-2", __iconNode$et);
  ...
  const FolderSearch = createLucideIcon("folder-search", __iconNode$es);
  ...
  const GalleryHorizontal = createLucideIcon("gallery-horizontal", __iconNode$e8);
  ...
  const Github = createLucideIcon("github", __iconNode$dK);
  ...
  const Gitlab = createLucideIcon("gitlab", __iconNode$dJ);
  ...
  const Glasses = createLucideIcon("glasses", __iconNode$dH);
  ...
  const Globe = createLucideIcon("globe", __iconNode$dF);
  ...
  const Goal = createLucideIcon("goal", __iconNode$dE);
  ...
  const GraduationCap = createLucideIcon("graduation-cap", __iconNode$dB);
  ...
  const Grape = createLucideIcon("grape", __iconNode$dA);
  ...
  const Group = createLucideIcon("group", __iconNode$dr);
  ...
  const Heading6 = createLucideIcon("heading-6", __iconNode$d3);
  ...
  const HeadphoneOff = createLucideIcon("headphone-off", __iconNode$c$);
  ...
  const HousePlug = createLucideIcon("house-plug", __iconNode$cK);
  ...
  const IdCard = createLucideIcon("id-card", __iconNode$cE);
  ...
  const ImageDown = createLucideIcon("image-down", __iconNode$cD);
  ...
  const Italic = createLucideIcon("italic", __iconNode$cl);
  ...
  const LampWallUp = createLucideIcon("lamp-wall-up", __iconNode$c3);
  ...
  const LayoutTemplate = createLucideIcon("layout-template", __iconNode$bP);
  ...
  const LifeBuoy = createLucideIcon("life-buoy", __iconNode$bI);
  ...
  const ListCheck = createLucideIcon("list-check", __iconNode$bA);
  ...
  const ListChecks = createLucideIcon("list-checks", __iconNode$bz);
  ...
  const MailSearch = createLucideIcon("mail-search", __iconNode$aZ);
  ...
  const MailWarning = createLucideIcon("mail-warning", __iconNode$aY);
  ...
  const MessageSquareOff = createLucideIcon("message-square-off", __iconNode$ab);
  ...
  const MessageSquarePlus = createLucideIcon("message-square-plus", __iconNode$aa);
  ...
  const MessageSquareX = createLucideIcon("message-square-x", __iconNode$a4);
  ...
  const Microchip = createLucideIcon("microchip", __iconNode$9_);
  ...
  const MonitorSmartphone = createLucideIcon("monitor-smartphone", __iconNode$9K);
  ...
  const MonitorSpeaker = createLucideIcon("monitor-speaker", __iconNode$9J);
  ...
  const Nut = createLucideIcon("nut", __iconNode$8Z);
  ...
  const Panda = createLucideIcon("panda", __iconNode$8C);
  ...
  const ParkingMeter = createLucideIcon("parking-meter", __iconNode$8g);
  ...
  const PawPrint = createLucideIcon("paw-print", __iconNode$8c);
  ...
  const PenTool = createLucideIcon("pen-tool", __iconNode$88);
  ...
  const PhilippinePeso = createLucideIcon("philippine-peso", __iconNode$7$);
  ...
  const PiggyBank = createLucideIcon("piggy-bank", __iconNode$7O);
  ...
  const Radical = createLucideIcon("radical", __iconNode$79);
  ...
  const ReceiptIndianRupee = createLucideIcon("receipt-indian-rupee", __iconNode$72);
  ...
  const ReceiptEuro = createLucideIcon("receipt-euro", __iconNode$70);
  ...
  const Reply = createLucideIcon("reply", __iconNode$6z);
  ...
  const RotateCcwSquare = createLucideIcon("rotate-ccw-square", __iconNode$6q);
  ...
  const ScreenShareOff = createLucideIcon("screen-share-off", __iconNode$5R);
  ...
  const SignalLow = createLucideIcon("signal-low", __iconNode$50);
  ...
  const SignpostBig = createLucideIcon("signpost-big", __iconNode$4X);
  ...
  const Touchpad = createLucideIcon("touchpad", __iconNode$24);
