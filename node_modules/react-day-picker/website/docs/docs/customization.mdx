...
To enable a navigation dropdown, assign `captionLayout="dropdown"`. Use `from*` and `to*` properties to define the [the start and end dates](./navigation.mdx#start-and-end-dates).
